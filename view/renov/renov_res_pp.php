...
<body>
    ...
    <div>
        <div class="card">
            ...
            <div class="card-body p-5 animated bounceInUp" id="tablaLoad" hidden="true">
                    ...
                    <table class="table table-hover table-striped table-bordered" id="tableRenovAct1" width="100%">
                        <thead class="blue-gradient text-white text-center">
                            <tr>
                                ...
                                <th>Nombre Titular</th>
                                <th>Cía</th>
                                <th class="text-nowrap">F Hasta Seguro</th>
                                <th>Ramo</th>
                                <th style="background-color: #E54848;">Prima Suscrita</th>
                ...
                <h1 class="font-weight-bold text-black-50">Pre-Renovadas</h1>
                <div class="table-responsive-xl">
                    <table class="table table-hover table-striped table-bordered" id="tableRenovAct4" width="100%">
                        <thead class="blue-gradient text-white text-center">
                            <tr>
                                <th hidden>f_hastapoliza</th>
                                <th hidden>id</th>
                ...
                <h1 class="title text-center">Total de Pólizas Pre-Renovadas de <?= $mes_arr[$_GET['mes'] - 1]; ?></h1>
                <h1 class="title text-danger text-center"><?= $cantPoliza; ?></h1>
    ...
    <div class="table-responsive-xl" id="tableRenovPolizas" hidden>
        <table class="table table-hover table-striped table-bordered" width="100%">
            <thead>
                ...
                <tr>
                    ...
                    <th style="background-color: #4285F4; color: white" colspan="3">Ramo</th>
        ...
        <table class="table table-hover table-striped table-bordered" width="100%">
            <thead>
                <tr>
                    <th style="text-align: center;font-size: 20px;" colspan="8">Pre-Renovadas</th>
                </tr>
                <tr>
                    <th style="background-color: #4285F4; color: white">N° Póliza</th>
                    <th style="background-color: #4285F4; color: white">Nombre Titular</th>
    ...
    <script>
        ...
        $("#tableRenovAct4 tbody tr").dblclick(function() {
            var customerId = $(this).find("td").eq(1).html();
