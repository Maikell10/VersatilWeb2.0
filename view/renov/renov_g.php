    ...
    <div>
        <div class="card">
            ...
            <div class="card-body p-5 animated bounceInUp" id="tablaLoad" hidden="true">
                ...
                <center><a class="btn dusty-grass-gradient" href="../excel/e_renov_g.php?anio=<?= $_POST['anio']; ?>&mes=<?= $_POST['mes']; ?>&asesor=<?= $asesorEnv; ?>&cia=<?= $ciaEnv; ?>" data-toggle="tooltip" data-placement="right" title="Exportar a Excel"><img src="../../assets/img/excel.png" width="60" alt=""></a></center>
                                        ...
                                        for ($i = 0; $i < sizeof($poliza); $i++) {
                                            ...
                                            <td nowrap>
                                                ...
                                                ?>
                                                            ...
                                                            ?>
                                                                <a href="../v_poliza.php?id_poliza=<?= $poliza_renov[0]['id_poliza']; ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="Renovada" class="btn aqua-gradient btn-rounded btn-sm btn-block">Renovada</a>
                                                            <?php
                                                            } else {
                                                            ?>
