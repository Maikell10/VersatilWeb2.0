    ...
    <div>
        <div class="card">
            ...
            <?php if ($_SESSION['id_permiso'] != 3) { ?>
                ...
                <div class="card-body p-5 animated bounceInUp" id="tablaLoad" hidden="true" style="z-index: 100">
                        ...
                        <div class="col-md-10 m-auto">
                            ...
                            <div class="tab-content card mt-2">
                                ...
                                <div class="tab-pane fade" id="panel102" role="tabpanel">
                                    ...
                                    <form action="carta_new_edit.php" class="form-horizontal" method="GET">
                                    <div style='background-color: #f4f4f4;'>
                                        ...
                                        <div style='width: 90%;margin: 0 auto;background-color: white'>
                                            <div style='padding: 30px'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="form-group" style='width: 85%;'>
                                                            <div class="input-group">
                                                                <textarea name="body" id="body" class="form-control" style="font-size: 1.6vw; text-align: justify;margin-top: 13px;font-style: italic;color: #6c757d;height: 43vw;" type="text" required><?= ($cartaNewData[0]['body']); ?></textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group" style='width: 85%'>
                                                    <div class="input-group">
                                                        <input name="escribame" id="escribame" class="form-control" style="font-size: 2vw" type="text" value="<?= $cartaNewData[0]['escribame']; ?>"  />
                                                    </div>
                                                </div>
                                                </center>
                                                    ...
                                                    <div style='background-color: #0f4296;color: white;width: 90%'>
                                                        ...
                                                        <center>
                                                            <div class="form-group" style='width: 90%'>
                                                                <div class="input-group">
                                                                    <textarea name="direccion" id="direccion" class="form-control" style="font-size: 2vw;height: 10vw;" type="text" required><?= $cartaNewData[0]['direccion']; ?></textarea>
                                                                </div>
                                                            </div>
                                                        </center>
                                                        <br>
