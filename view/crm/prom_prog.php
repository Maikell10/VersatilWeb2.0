        ...
        <script>
            function programar() {
                ...
                alertify.confirm('!!', '¿Desea Programar el Mensaje para la búsqueda actual?',
                    function() {
                        window.location.replace("../../procesos/agregarMPprom.php?ramo=<?= $ramoEnv; ?>&t_poliza=<?= $t_polizaEnv; ?>&v_poliza=<?= $v_poliza; ?>&cia=<?= $ciaEnv; ?>&asesor=<?= $asesorEnv; ?>&filtroTPoliza=<?= $filtroTPoliza; ?>&filtroCia=<?= $filtroCia; ?>&filtroRamo=<?= $filtroRamo; ?>&filtroAsesor=<?= $filtroAsesor; ?>&copiaAsesor="+copiaAsesor+"&fEnvio="+$('#fEnvio').val()+"&frecuencia="+$('#frecuencia').val());
                    },
                    function() {
