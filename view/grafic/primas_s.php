            ...
            <a href="javascript:history.back(-1);" data-toggle="tooltip" data-placement="right" title="Ir la página anterior" class="btn blue-gradient btn-rounded ml-5">
                <- Regresar</a> <br><br>
                    <div class="m-auto col-md-10">
                        <h1 class="font-weight-bold ">Gráficos de Primas Suscritas</h1>
                    </div>
                    ...
                    <div class="m-auto col-md-10">
                        <div class="card-deck">
                            <div class="card bg-info mb-3">
                                <a href="Primas_Suscritas/busqueda_ramo.php" class="hoverable">
                                    <div class="card-body">
                                        <center>
                            ...
                            <div class="card bg-info mb-3">
                                <a href="Primas_Suscritas/busqueda_prima_mes.php" class="hoverable">
                                    <div class="card-body">
                                        <center>
                        ...
                        <div class="card-deck">
                            <div class="card bg-info mb-3">
                                <a href="Primas_Suscritas/busqueda_cia.php" class="hoverable">
                                    <div class="card-body">
                                        <center>
