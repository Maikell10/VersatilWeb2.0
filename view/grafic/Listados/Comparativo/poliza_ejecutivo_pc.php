...
$pag = 'ComparativoL/poliza_ejecutivo';
            ...
            <?php if ($_SESSION['id_permiso'] != 3) { ?>
                <div class="card-header p-5 animated bounceInDown" id="headerload" hidden="true">
                    <div class="ml-5 mr-5 text-center">
                        ...
                        <h3>Comparativo de Primas Cobradas por Ejecutivo: <?= $_GET['codvend'];?></h3>
                    </div>
                </div>
                <hr />
                ...
                <div class="card-body p-5 animated bounceInUp" id="tablaLoad" hidden="true">
                    ...
                    <h2 class="font-weight-bold">Pólizas Año: <?= $anio; ?></h2>
                    ...
                    <p class="h1 text-center text-danger"><?php echo $canpolizasC; ?></p>



                    <h2 class="font-weight-bold">Pólizas Año: <?= $anio-1; ?></h2>
                    <div class="table-responsive-xl">
                        <table class="table table-hover table-striped table-bordered" id="PorcentajeRamo1" width="100%">
                            <thead class="blue-gradient text-white text-center">
                                <tr>
                                    <th hidden>f_poliza</th>
                                    <th hidden>id</th>
                            ...
                            <tbody>
                                ...
                                $totalprima = 0;
                                $totalprimaC = 0;
                                for ($i = 0; $i < $canpolizasCold; $i++) {
                                    $polizas = $obj->get_poliza_total_by_filtro_utilidad_v($polizasCold[$i]['id_poliza']);
                                    ...
                                    foreach ($polizas as $poliza) {
                                        ...
                                        $primac = $obj->obetnComisionesUtilidadG($poliza['id_poliza'], $mes,$anio-1);
                    ...
                    <div class="table-responsive-xl" hidden>
                        <table class="table table-hover table-striped table-bordered" id="PorcentajeRamoE">
                            <thead class="blue-gradient text-white text-center">
                                <tr>
                                    <th class="text-center" style="background-color: #D9D9D9; color: black" colspan="10">Pólizas Año: <?= $anio; ?></th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th class="text-center" style="background-color: #D9D9D9; color: black" colspan="10">Pólizas Año: <?= $anio-1; ?></th>
                                </tr>
                                <tr>
                                    <th class="text-center" style="background-color: #4285F4; color: white"></th>
                                    <th class="text-center" style="background-color: #4285F4; color: white">N° Póliza</th>
                    ...
                    <p class="h1 text-center">Total de Pólizas</p>
                    <p class="h1 text-center text-danger"><?php echo $canpolizasCold; ?></p>
                </div>
