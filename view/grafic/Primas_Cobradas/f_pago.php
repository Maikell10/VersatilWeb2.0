...
<body>
                ...
                <a href="javascript:history.back(-1);" data-toggle="tooltip" data-placement="right" title="Ir la página anterior" class="btn blue-gradient btn-rounded ml-5">
                    <- Regresar</a> <br><br>
                        <div class="ml-5 mr-5">
                            ...
                            <center><a class="btn dusty-grass-gradient" onclick="tableToExcel('tableE', 'Primas Cobradas por Forma de Pago')" data-toggle="tooltip" data-placement="right" title="Exportar a Excel"><img src="../../../assets/img/excel.png" width="40" alt=""></a></center>
                        </div>
            </div>
    ...
    <script>
        $("#table tbody tr").dblclick(function() {
            var fpago = $(this).find("th").eq(0).html();
            ...
            window.open("../Listados/Primas_Cobradas/poliza_fpago.php?ramo=" + ramo + "&anio=" + anio + "&cia=" + cia + "&tipo_cuenta=" + tipo_cuenta + "&asesor_u=" + asesor_u + "&fpago=" + fpago , '_blank');
        });
