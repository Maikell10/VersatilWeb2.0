    ...
    <div>
        ...
        <script type="text/javascript">
            ...
            $("#table tbody tr").dblclick(function() {
                ...
                var ramo = $(this).find("td").eq(4).html();
                ...
                window.open("../../Listados/Comparativo/poliza_cia.php?ramo=" + ramo + "&anio=" + anio + "&mes=" + mes + "&cia=" + cia + "&tipo_cuenta=" + tipo_cuenta + "&asesor_u=" + asesor_u, '_blank');
            });
