    ...
    <div>
        ...
        <script>
            ...
            $("#table tbody tr").dblclick(function() {
                ...
                var cia = $(this).find("td").eq(6).html();
                var tipo_cuenta = $(this).find("td").eq(7).html();
                var asesor_u = $(this).find("td").eq(8).html();

                window.open("../../Listados/Comparativo/poliza_ramo_pc.php?ramo=" + ramo + "&anio=" + anio + "&mes=" + mes + "&cia=" + cia + "&tipo_cuenta=" + tipo_cuenta + "&asesor_u=" + asesor_u, '_blank');
            });
