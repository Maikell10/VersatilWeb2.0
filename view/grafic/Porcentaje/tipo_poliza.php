...
<body>
        ...
        <div class="card">
            ...
            <div class="card-header p-5 animated bounceInDown">
                <a href="javascript:history.back(-1);" data-toggle="tooltip" data-placement="right" title="Ir la página anterior" class="btn blue-gradient btn-rounded ml-5">
                    <- Regresar</a> <br><br>
                        <div class="ml-5 mr-5">
                            <h1 class="font-weight-bold text-center">Distribución de la Cartera por Tipo de Póliza</h1>
                            ...
                            <center><a class="btn dusty-grass-gradient" onclick="tableToExcel('tableE', 'Distribución de la Cartera por Tipo de Póliza')" data-toggle="tooltip" data-placement="right" title="Exportar a Excel"><img src="../../../assets/img/excel.png" width="40" alt=""></a></center>
                        </div>
            </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr style="cursor: pointer">
                                        ...
                                        <td align="center"><?= number_format(($sumatotalTpoliza[$x[$i]] * 100) / $totals, 2) . " %"; ?></td>
    ...
    <script>
        $("#table tbody tr").dblclick(function () {
            var tpoliza = $(this).find("td").eq(9).html();
            ...
            window.open("../Listados/Porcentaje/poliza_tpoliza.php?ramo=" + ramo + "&desde=" + desde + "&hasta=" + hasta + "&cia=" + cia + "&tipo_cuenta=" + tipo_cuenta + "&asesor_u=" + asesor_u + "&tpoliza=" + tpoliza , '_blank');
        });
