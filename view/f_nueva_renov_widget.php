    ...
    <div>
        <div class="card">
            ...
            <div class="card-header p-5 animated bounceInDown" id="headerload" hidden="true">
                <div class="ml-5 mr-5">
                    <h1 class="font-weight-bold">Resultado de Búsqueda de Pólizas Renovadas</h1>
                ...
                <div class="table-responsive-xl" hidden>
                    <table class="table table-hover table-striped table-bordered" id="tableE" width="100%">
                        <thead class="text-center">
                            <tr>
                                <th colspan="10" style="font-size:25px; font-weight: bold;background-color: #E9E9E9">Pólizas Renovadas</th>
                            </tr>
                            <tr>
