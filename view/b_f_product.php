                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <div class="md-form">
                                                ...
                                                <input placeholder="Fecha inicio" type="text" id="startingDate" name="desdeP" class="form-control datepicker">
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="md-form">
                                                <!--The "to" Date Picker -->
                                                <input placeholder="Fecha fin" type="text" id="endingDate" name="hastaP" class="form-control datepicker">
