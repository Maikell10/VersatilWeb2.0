            ...
            ?>
                    <div class="card-header p-5 animated bounceInDown">
                        <a href="../administracion.php" data-toggle="tooltip" data-placement="right" title="Ir la página anterior" class="btn blue-gradient btn-rounded ml-5">
                            <- Regresar</a> <br><br>
                                <div class="ml-5 mr-5">
                                    <h1 class="font-weight-bold text-center">Generar Pago de la GC (REFERIDORES)</h1>
                                </div>
                                <br><br><br>
                ...
                <?php } else { ?>
                    <div class="card-header p-5 animated bounceInDown">
                        <a href="javascript:history.back(-1);" data-toggle="tooltip" data-placement="right" title="Ir la página anterior" class="btn blue-gradient btn-rounded ml-5">
                            <- Regresar</a> <br><br>
                                <div class="ml-5 mr-5">
                                    <h1 class="font-weight-bold text-center">Generar GC (REFERIDORES)</h1>
                                </div>
                                <br><br><br>

                                <div class="col-md-8 mx-auto">
                                    <h2 class="text-center font-weight-bold text-danger">No hay REFERIDORES para generar GC disponibles</h2>
                                </div>
                    </div>
            <?php }
            }
