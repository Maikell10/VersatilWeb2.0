            ...
            <?php if ($_SESSION['id_permiso'] != 3) { ?>
                <div class="card-header p-5 animated bounceInDown" id="headerload" hidden="true">
                    <a href="javascript:history.back(-1);" data-toggle="tooltip" data-placement="right" title="Ir la página anterior" class="btn blue-gradient btn-rounded ml-5">
                        <- Regresar</a> <br><br>
                            <div class="ml-5 mr-5">
                                <h1 class="font-weight-bold">Cargar Pago(s) de GC por Referidor</h1>
                ...
                <div class="card-body p-5 animated bounceInUp" id="tablaLoad" hidden>
                    ...
                    <form action="../../procesos/agregarGC_R.php" name="form1">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        for ($i = 0; $i < sizeof($poliza); $i++) {
                                            ...
                                            $tooltip = 'F Desde Seguro: ' . $newDesde . ' | Nombre Titular: ' . $nombretitu . ' | Cía: ' . $poliza[$i]['nomcia'];
                                            ...
                                            ?>
                                                <td data-toggle="tooltip" data-placement="top" title="<?= $tooltip; ?>" style="color: #2B9E34"><?= $poliza[$i]['cod_poliza']; ?></td>
                                            <?php
                                            } else {
                                            ?>
                                                <td data-toggle="tooltip" data-placement="top" title="<?= $tooltip; ?>" style="color: #E54848"><?= $poliza[$i]['cod_poliza']; ?></td>
                                            <?php
                                            }
                                            ?>
                                            ...
                                            <td align="right" data-toggle="tooltip" data-placement="top" title="<?= $tooltip; ?>"><?= "$ " . number_format($monto_pago_prima[0]['prima_com'], 2); ?></td>
                                            ...
                                            <td>
                                                <div class="input-group md-form my-n1">
                                                    <input type="text" class="form-control datepicker" id="f_pago_gc_r<?= $poliza[$i]['id_poliza'];?>" name="f_pago_gc_r<?= $poliza[$i]['id_poliza'];?>" required value="<?= date('d-m-Y') ?>">
                                                </div>
                                            </td>
