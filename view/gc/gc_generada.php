        ...
        <div class="card">
            ...
            <?php if ($_SESSION['id_permiso'] != 3) { ?>
                ...
                <div class="card-body p-5 animated bounceInUp" id="tablaLoad" hidden>
                    ...
                    <center><a class="btn dusty-grass-gradient" href="../excel/e_gc_generada.php?anio=<?= $anio; ?>&mes=<?= $mes; ?>" data-toggle="tooltip" data-placement="right" title="Exportar a Excel"><img src="../../assets/img/excel.png" width="60" alt=""></a></center>
                    ...
                    <h3 class="text-black-50 font-weight-bold">GC Referidores</h3>
                        <table class="table table-hover table-striped table-bordered" id="mytableGCRefG" style="cursor: pointer;">
                            <thead class="blue-gradient text-white">
                                <tr>
                                    <th>Referidor</th>
                            ...
                            <tbody>
                                ...
                                for ($a = 0; $a < $cantdistinct_r; $a++) {
                                    ...
                                    $distinct_fdp = $obj->get_distinct_fgc_carg_by_r($desde, $hasta, $distinct_r[$a]['codvend']);
                                ?>
                                    <tr>
                                        <?php
                                        ...
                                        for ($b = 0; $b < sizeof($distinct_fdp); $b++) {
                                            ...
                                            $poliza = $obj->get_gc_carg_by_r_by_fpgc($distinct_r[$a]['codvend'], $distinct_fdp[$b]['mes'],$distinct_fdp[$b]['anio']);
                    ...
                    <h3 class="text-black-50 font-weight-bold">GC Proyectos</h3>
                        <table class="table table-hover table-striped table-bordered" id="mytableGCProyG" style="cursor: pointer;">
                            <thead class="blue-gradient text-white">
                                <tr>
                                    <th>Proyecto</th>
                                    <th>Mes Desde Póliza</th>
                            ...
                            <tbody>
                                ...
                                for ($a = 0; $a < $cantdistinct_p; $a++) {
                                    ...
                                    $distinct_fdp = $obj->get_distinct_fgc_carg_by_p($desde, $hasta, $distinct_p[$a]['codvend']);
                                ?>
                                    <tr>
                                        <?php
                                        ...
                                        for ($b = 0; $b < sizeof($distinct_fdp); $b++) {
                                            ...
                                            $poliza = $obj->get_gc_carg_by_p_by_fpgc($distinct_p[$a]['codvend'], $distinct_fdp[$b]['mes'],$distinct_fdp[$b]['anio']);
