        ...
        <div class="card">
            ...
            <div class="card-header p-5 animated bounceInDown">
                <a href="javascript:history.back(-1);" data-toggle="tooltip" data-placement="right" title="Ir la página anterior" class="btn blue-gradient btn-rounded ml-5">
                    <- Regresar</a> <br><br>
                        <div class="ml-5 mr-5">
                            <h1 class="font-weight-bold text-center"><i class="fas fa-book" aria-hidden="true"></i>&nbsp;Previsualizar Carga de la Póliza Pendiente N° <?= $n_poliza; ?></h1>
                        </div>
            </div>
            ...
            <form class="form-horizontal" id="frmnuevo" action="e_poliza_n.php" method="post">
                <div class="card-body p-5">
                    ...
                    <center>
                        <a name="enlace" href="crear_pp_n.php?id_poliza=<?= $id_poliza; ?>&n_poliza=<?= $n_poliza; ?>&fhoy=<?= $fhoy; ?>&emisionP=<?= $femisionP; ?>&t_cobertura=<?= $t_cobertura; ?>&desdeP=<?= $fdesdeP; ?>&hastaP=<?= $fhastaP; ?>&currency=<?= $currency; ?>&tipo_poliza=<?= $tipo_poliza; ?>&sumaA=<?= $sumaA; ?>&z_produc=<?= $z_produc; ?>&asesor=<?= $u[0]; ?>&ramo=<?= $ramo; ?>&cia=<?= $cia; ?>&titular=<?= $titular; ?>&n_recibo=<?= $n_recibo; ?>&desde_recibo=<?= $fdesde_recibo; ?>&hasta_recibo=<?= $fhasta_recibo; ?>&prima=<?= $prima; ?>&f_pago=<?= $f_pago; ?>&n_cuotas=<?= $n_cuotas; ?>&monto_cuotas=<?= $monto_cuotas; ?>&tomador=<?= $tomador; ?>&placa=<?= $placa; ?>&tipo=<?= $tipo; ?>&marca=<?= $marca; ?>&modelo=<?= $modelo; ?>&anio=<?= $anio; ?>&color=<?= $color; ?>&serial=<?= $serial; ?>&categoria=<?= $categoria; ?>&per_gc=<?= $por_gc; ?>&t_cuenta=<?= $_POST['t_cuenta']; ?>&obs_p=<?= $obs_p; ?>&campos=<?= $campos; ?>&forma_pago=<?= $_POST['forma_pago']; ?>&n_tarjeta=<?= $n_tarjeta; ?>&n_tarjeta_h=<?= $n_tarjeta_h; ?>&cvv=<?= $cvv; ?>&fechaV=<?= $fechaV; ?>&titular_tarjeta=<?= $titular_tarjeta; ?>&bancoT=<?= $bancoT; ?>&alert=<?= $alert; ?>&id_tarjeta=<?= $id_tarjeta; ?>&condTar=<?= $condTar; ?>" class="btn blue-gradient btn-lg btn-rounded">Confirmar</a>
                    </center>
                </div>
            </form>
        </div>
