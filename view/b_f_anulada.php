            ...
            <?php if ($_SESSION['id_permiso'] != 3) { ?>
                <div class="card-header p-5 animated bounceInDown">
                    <a href="javascript:history.back(-1);" data-toggle="tooltip" data-placement="right" title="Ir la página anterior" class="btn blue-gradient btn-rounded ml-5">
                        <- Regresar</a> <br><br>
                            <div class="ml-5 mr-5">
                                <h1 class="font-weight-bold ">Pólizas Anuladas</h1>
                            </div>
                            <br>

                            <div class="col-md-8 mx-auto">
                                <form action="f_anulada.php" class="form-horizontal" method="GET">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <div class="md-form">
                                                <!--The "from" Date Picker -->
                                                <input placeholder="Fecha inicio" type="text" id="startingDate" name="desdeP" class="form-control datepicker" required>
                                                <label for="startingDate">Fecha de la Búsqueda (Desde Seg):</label>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <div class="md-form">
                                                ...
                                                <label for="endingDate">Fecha de la Búsqueda (Hasta Seg):</label>
                                            </div>
                                        </div>
                                    </div>
