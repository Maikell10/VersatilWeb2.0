...
$poliza_f = $obj->get_poliza_existente($_POST['num_polizaE'], $f_hasta, $f_hasta_n);

if ($poliza_f[0]['f_hastapoliza'] == $f_hasta_n && $poliza_f[0]['f_desdepoliza'] == $f_hasta && $poliza_f[0]['cod_poliza'] == $_POST['num_polizaE']) {
return 0;
} else {
