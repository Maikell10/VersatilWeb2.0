...
class Grafico extends Poliza
{
    ...
    public function get_poliza_graf_1_comp($ramo, $anio, $mes, $cia, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_poliza_graf_1_comp_by_user($ramo, $anio, $mes, $cia, $tipo_cuenta, $asesor)
    {
        if ($cia != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_poliza_graf_3_comp($cia, $ramo, $anio, $mes, $tipo_cuenta)
    {
    ...
    public function get_poliza_graf_3_by_user_comp($cia, $ramo, $anio, $mes, $tipo_cuenta, $asesor)
    {
    ...
    public function get_poliza_graf_5($codvend, $ramo, $desde, $hasta, $cia, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_poliza_graf_5_comp($codvend, $ramo, $anio, $mes, $cia, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_mes_prima_by_user($cond1, $cond2, $cia, $ramo, $tipo_cuenta, $m, $cod_asesor)
    {
    ...
    public function get_poliza_grafp_2_list($ramo, $desde, $hasta, $cia, $tipo_cuenta)
    {
    ...
    public function get_poliza_grafp_2_list_by_user($ramo, $desde, $hasta, $cia, $tipo_cuenta, $asesor)
    {
    ...
    public function get_poliza_c_cobrada_ramo($ramo, $cia, $anio, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '') {
            ...
            $sql = "SELECT prima, f_pago_prima, prima_com, comision FROM poliza 
					INNER JOIN dcia, dramo, comision WHERE 
					poliza.id_cia=dcia.idcia AND
					poliza.id_cod_ramo=dramo.cod_ramo AND
					poliza.id_poliza = comision.id_poliza AND 
    ...
    public function get_distinct_id_poliza_c_cobrada_ramo($ramo, $cia, $anio, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_ramo_by_user($ramo, $cia, $anio, $tipo_cuenta, $asesor)
    {
        if ($cia != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_ramo_comp($ramo, $cia, $anio, $tipo_cuenta, $mes)
    {
        if ($cia != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_ramo_by_user_comp($ramo, $cia, $anio, $tipo_cuenta, $asesor, $mes)
    {
        if ($cia != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_count_poliza_c_cobrada_mes($ramo, $cia, $desde, $hasta, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_count_poliza_c_cobrada_mes_by_user($ramo, $cia, $desde, $hasta, $tipo_cuenta, $asesor)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_mes($ramo, $cia, $desde, $hasta, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_mes_by_user($ramo, $cia, $desde, $hasta, $tipo_cuenta, $asesor)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_cia($ramo, $cia, $anio, $tipo_cuenta)
    {
        if ($ramo != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ramoIn = "('" . implode("','", $ramo) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_cia_by_user($ramo, $cia, $anio, $tipo_cuenta, $asesor)
    {
        if ($ramo != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ramoIn = "('" . implode("','", $ramo) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_cia_comp($ramo, $cia, $anio, $tipo_cuenta, $mes)
    {
        if ($ramo != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ramoIn = "('" . implode("','", $ramo) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_cia_by_user_comp($ramo, $cia, $anio, $tipo_cuenta, $asesor, $mes)
    {
        if ($ramo != '' && $tipo_cuenta != '') {
            // create sql part for IN condition by imploding comma after each id
            $ramoIn = "('" . implode("','", $ramo) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_tpoliza($ramo, $cia, $anio, $tipo_cuenta, $t_poliza)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_tpoliza_by_user($ramo, $cia, $anio, $tipo_cuenta, $t_poliza, $asesor)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_ejecutivo($ramo, $cia, $anio, $tipo_cuenta, $ejecutivo)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_ejecutivo_comp($ramo, $cia, $anio, $tipo_cuenta, $ejecutivo, $mes)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_poliza_c_cobrada_f_pago($f_pago, $cia, $ramo, $anio, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            ...
            $sql = "SELECT f_pago_prima, poliza.prima, prima_com, comision FROM poliza 
    ...
    public function get_distinct_id_poliza_c_cobrada_fpago($ramo, $cia, $anio, $tipo_cuenta, $fpago)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_distinct_id_poliza_c_cobrada_fpago_by_user($ramo, $cia, $anio, $tipo_cuenta, $fpago, $asesor)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
    ...
    public function get_poliza_graf_1_pc($ramo, $desde, $hasta, $cia, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '') {
            ...
            $sql = "SELECT prima_com, comision, per_gc FROM comision INNER JOIN poliza, dramo, dcia WHERE 
								   poliza.id_cod_ramo=dramo.cod_ramo AND
								   poliza.id_cia=dcia.idcia AND
    ...
    public function get_mes_prima_pc($cond1, $cond2, $cia, $ramo, $tipo_cuenta, $m)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            ...
            $sql = "SELECT DISTINCT Month(f_desdepoliza) FROM poliza,dcia,dramo,comision
								WHERE 
								poliza.id_cod_ramo=dramo.cod_ramo AND
								poliza.id_cia=dcia.idcia AND
								poliza.id_poliza=comision.id_poliza AND
    ...
    public function get_poliza_grafp_2_pc($ramo, $desde, $hasta, $cia, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            ...
            $sql = "SELECT prima, prima_com, comision, per_gc FROM comision INNER JOIN poliza, dcia, dramo WHERE  
                                poliza.id_cod_ramo=dramo.cod_ramo AND 
                                poliza.id_cia=dcia.idcia AND 
                                comision.id_poliza=poliza.id_poliza AND
                                f_desdepoliza >= '$desde' AND
    ...
    public function get_distinct_element_tpoliza_pc($desde, $hasta, $cia, $ramo, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            ...
            $sql = "SELECT DISTINCT tipo_poliza FROM poliza, tipo_poliza, dcia, dramo, comision WHERE 
                                poliza.id_tpoliza=tipo_poliza.id_t_poliza AND
                                poliza.id_cia=dcia.idcia AND
                                poliza.id_cod_ramo=dramo.cod_ramo AND
                                poliza.id_poliza=comision.id_poliza AND
    ...
    public function get_poliza_graf_2_pc($tpoliza, $ramo, $desde, $hasta, $cia, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            ...
            $sql = "SELECT prima, prima_com, comision, per_gc FROM comision INNER JOIN poliza, dramo, dcia, tipo_poliza WHERE 
                                poliza.id_cod_ramo=dramo.cod_ramo AND
                                poliza.id_cia=dcia.idcia AND
                                poliza.id_tpoliza=tipo_poliza.id_t_poliza AND
                                comision.id_poliza=poliza.id_poliza AND
    ...
    public function get_distinct_element_fpago_pc($desde, $hasta, $cia, $ramo, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            ...
            $sql = "SELECT DISTINCT fpago FROM poliza, dcia, dramo, comision, drecibo WHERE 
                                poliza.id_cia=dcia.idcia AND
                                poliza.id_poliza=drecibo.idrecibo AND 
                                poliza.id_cod_ramo=dramo.cod_ramo AND
                                poliza.id_poliza=comision.id_poliza AND
    ...
    public function get_poliza_graf_4_pc($fpago, $ramo, $desde, $hasta, $cia, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            ...
            FROM comision INNER JOIN poliza, dramo, dcia, drecibo WHERE 
								   poliza.id_cod_ramo=dramo.cod_ramo AND
                                   poliza.id_poliza=drecibo.idrecibo AND 
								   poliza.id_cia=dcia.idcia AND
								   comision.id_poliza=poliza.id_poliza AND
    ...
    public function get_distinct_element_ejecutivo_pc($desde, $hasta, $cia, $ramo, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
            ...
            $sql = "SELECT DISTINCT codvend, idnom AS nombre 
                            FROM poliza, dcia, dramo, ena WHERE 
                            poliza.id_cia=dcia.idcia AND 
                            poliza.id_cod_ramo=dramo.cod_ramo AND
                            poliza.codvend = ena.cod AND
                            f_desdepoliza >= '$desde' AND
                        ...
                        SELECT DISTINCT codvend, nombre 
                            FROM poliza, dcia, dramo, enr WHERE 
                            poliza.id_cia=dcia.idcia AND 
                            poliza.id_cod_ramo=dramo.cod_ramo AND
                            poliza.codvend = enr.cod AND
                            f_desdepoliza >= '$desde' AND
                        ...
                        SELECT DISTINCT codvend, nombre 
                            FROM poliza, dcia, dramo, enp WHERE 
                            poliza.id_cia=dcia.idcia AND 
                            poliza.id_cod_ramo=dramo.cod_ramo AND
                            poliza.codvend = enp.cod AND
                            f_desdepoliza >= '$desde' AND
    ...
    {
        if ($mes != '') {
            $mes = ' AND MONTH(f_pago_prima)='.$mes;
        } else {
            $mes = '';
        }
    ...
    public function get_distinct_ramo_prima_c_comp_by_user($anio, $mes, $cia, $tipo_cuenta, $asesor)
    {
        if ($mes != '') {
            $mes = ' AND MONTH(f_pago_prima)='.$mes;
        } else {
    ...
    public function get_poliza_c_cobrada_ramo_comp_by_user($ramo, $cia, $anio, $mes, $tipo_cuenta, $asesor)
    {
        if ($mes != '') {
            $mes = 'MONTH(f_pago_prima)='.$mes.' AND';
        } else {
            $mes = '';
        }
    ...
    public function get_count_poliza_c_cobrada_ramo_comp_by_user($ramo, $cia, $anio, $mes, $tipo_cuenta, $asesor)
	{
        if ($mes != '') {
            $mes = 'MONTH(f_pago_prima)='.$mes.' AND';
        } else {
    ...
    public function get_distinct_ejecutivo_prima_c_comp($anio, $mes, $cia, $ramo, $tipo_cuenta)
    {
        if ($mes != '') {
            $mes = ' AND MONTH(f_pago_prima)='.$mes;
        } else {
        ...
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            ...
            $sql = "SELECT DISTINCT poliza.codvend, idnom AS nombre FROM poliza 
                        INNER JOIN dcia, dramo, comision, ena WHERE 
                        poliza.id_cia=dcia.idcia AND
                        poliza.id_cod_ramo=dramo.cod_ramo AND
                        poliza.id_poliza = comision.id_poliza AND 
                        ...
                        SELECT DISTINCT poliza.codvend, nombre FROM poliza 
                        INNER JOIN dcia, dramo, comision, enr WHERE 
                        poliza.id_cia=dcia.idcia AND
                        poliza.id_cod_ramo=dramo.cod_ramo AND
                        poliza.id_poliza = comision.id_poliza AND 
    ...
    public function get_poliza_c_cobrada_ejecutivo_comp($codvend, $cia, $ramo, $anio, $mes, $tipo_cuenta)
    {
        if ($mes != '') {
            $mes = 'MONTH(f_pago_prima)='.$mes.' AND';
        } else {
    ...
    public function get_count_poliza_c_cobrada_ejecutivo_comp($codvend, $cia, $ramo, $anio, $mes, $tipo_cuenta)
	{
        if ($mes != '') {
            $mes = 'MONTH(f_pago_prima)='.$mes.' AND';
        } else {
    ...
    public function get_distinct_cia_prima_c_comp_by_user($anio, $mes, $ramo, $tipo_cuenta, $asesor)
    {
        if ($mes != '') {
            $mes = ' AND MONTH(f_pago_prima)='.$mes;
        } else {
    ...
    public function get_poliza_c_cobrada_cia_comp_by_user($cia, $ramo, $anio, $mes, $tipo_cuenta, $asesor)
    {
        if ($mes != '') {
            $mes = 'MONTH(f_pago_prima)='.$mes.' AND';
        } else {
    ...
    public function get_count_poliza_c_cobrada_cia_comp_by_user($cia, $ramo, $anio, $mes, $tipo_cuenta, $asesor)
	{
        if ($mes != '') {
            $mes = 'MONTH(f_pago_prima)='.$mes.' AND';
        } else {
    ...
    public function get_poliza_pc_mm_cant($ramo, $desde, $hasta, $cia, $tipo_cuenta)
    {
        if ($cia != '' && $tipo_cuenta != '' && $ramo != '') {
            // create sql part for IN condition by imploding comma after each id
            $ciaIn = "('" . implode("','", $cia) . "')";
